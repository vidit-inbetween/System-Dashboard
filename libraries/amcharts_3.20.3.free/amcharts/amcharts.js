...
(function () {
  ...
  d.AxisBase = d.Class({
    construct: function (a) {
      ...
      this.fire({
        type: c,
        value: b.value, serialDataItem: b.serialDataItem, axis: this, target: b.label, chart: this.chart, event: a
      })
    }, addGuide: function (a) {
      ...
      var u,
          x = this.gridAlpha, z, v = this.choosePeriod(0), A = v.period, v = v.count, y = d.getPeriodDuration(A, v);
      y < k && (A = g.period, v = g.count, y = k);
      g = A;
      "WW" == g && (g = "DD");
      this.stepWidth = this.getStepWidth(this.timeDifference);
      var B = Math.ceil(this.timeDifference / y) + 5, D = l = d.resetDateToMin(new Date(this.startTime - y), A, v, t).getTime();
      ...
      if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)e = !0; else {
        ...
        if (this.autoGridCount || 0 !== this.gridCount)if ("date" == c)this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime =
          ...
          if (!isNaN(y) && 0 < A && g < r - 1) {
            ...
            for (J = 1; J < v; J++) {
              var H = this.getCoordinate(t + y * J), H = new this.axisItemRenderer(this, H, "", !1, 0, 0, !1, !1, 0, !0);
              this.pushAxisItem(H)
            }
            this.gridAlpha =
                f
...
(function () {
  ...
  d.RecItem = d.Class({
    construct: function (a, b, c, e, h, f, g, k, l, m, n, q) {
      ...
      this.set = z;
      var v = a.axisThickness, A = a.axisColor, y = a.axisAlpha, B = a.tickLength, D = a.gridAlpha, C = a.gridThickness, J = a.gridColor, H = a.dashLength, S = a.fillColor, O = a.fillAlpha, Q = a.labelsEnabled;
      n = a.labelRotationR;
      var ia = a.counter, I = a.inside, Z = a.labelOffset, va = a.dx, ma = a.dy, Oa = a.orientation, ea = a.position, ca = a.previousCoord, X = a.height, ya = a.width, da = a.offset, fa, za;
  ...
  d.AmGraph = d.Class({
    construct: function (a) {
      ...
      var m = this.useNegativeColorIfDown, n = this.width, q = this.height,
          p = this.y, t = this.rotate, r = this.columnCount, u = d.toCoordinate(this.cornerRadiusTop, k / 2), x = this.connect, z = [], v = [], A, y, B, D, C = this.chart.graphs.length, J, H = this.dx / this.tcc, S = this.dy / this.tcc, O = f.stackType, Q = this.start, ia = this.end, I = this.scrollbar, Z = "graph-column-";
      I && (Z = "scrollbar-graph-column-");
      var va = this.categoryAxis, ma = this.baseCoord, Oa = this.negativeBase, ea = this.columnIndex, ca = this.lineThickness, X = this.lineAlpha, ya = this.lineColorR, da = this.dashLength, fa = this.set, za, ga = this.getGradRotation(), T = this.chart.columnSpacing,
          Y = va.cellWidth, Ca = (Y * k - r) / r;
      T > Ca && (T = Ca);
      var G, w, na, ha = q, Pa = n, ba = 0, tb = 0, ub, vb, gb, hb, wb = this.fillColorsR, Qa = this.negativeFillColors, Ja = this.negativeLineColor, Ya = this.fillAlphas, Za = this.negativeFillAlphas;
      ...
      for (L = Q; L <= ia; L++) {
        ...
        var R, P, K, aa, ja = NaN, E = NaN, F = NaN, N = NaN, M = NaN, pa = NaN, qa = NaN, ra = NaN, sa = NaN, wa = NaN, Da = NaN, ka = NaN, la = NaN, W = NaN, zb = NaN, Ab = NaN, ta = NaN, ua = void 0, Ma = wb, Va = Ya, Ha = ya,
            ...
            case "candlestick":
              if (!isNaN(ta) && !isNaN(W)) {
                ...
                if (t) {
                  ...
                  if (R < n && 0 < K) {
                    Bb && W >= ta && (Va = 0);
                    var ua = new d.Cuboid(h, K, aa, H, S, Ma, Va, ca, Aa, X, ga, u, t, da, bb, mb, Z), Fb, Gb;
            ...
            if (this.end - this.start <= Ub || 0 === Ub) {
              ...
              if ("regular" == O || "100%" == O) {
                ...
                if (Yb) {
                  ...
                  if (Na) {
                    var Zb = Na.getBBox(), $b = Zb.width, ac = Zb.height, db, eb, sb = f.totalTextOffset, bc = f.totals[L];
                    bc && bc.remove();
                    var fb = 0;
      ...
      if (1 < a.length) {
        ...
        h.push(l);
        h.push(k);
        var m = this.lineAlpha, n = this.lineThickness, h = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, u = this.negativeFillColors, x = this.negativeFillAlphas, z = this.baseCoord, v = this.lineColorSwitched;
        v && (p = v);
    ...
    construct: function (a) {
      ...
      if (this.mouseIsDown) {
        var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY -
            this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3), e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), h = !1;
    ...
    construct: function (a) {
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          var r = this.horizontalPadding, u = this.verticalPadding, x = this.pointerWidth, z = this.pointerOrientation, v = this.cornerRadius,
          ...
          D < g && (D = g);
          D + C > l && (D = l - C);
          var k = y + u, m = D + r, O = this.shadowAlpha, Q = this.shadowColor, r = this.borderThickness, ia = this.bulletSize, I, u = this.fillAlpha, Z = this.borderAlpha;
...
(function () {
  ...
  d.TrendLine = d.Class({
    construct: function (a) {
      ...
      var a = this;
      a.destroy();
      var b = a.chart, c = b.container, e, h, f, g, k = a.categoryAxis, l = a.initialDate, m = a.initialCategory, n = a.finalDate, q = a.finalCategory, p = a.valueAxis, t = a.valueAxisX, r = a.initialXValue, u = a.finalXValue, x = a.initialValue, z =
...
(function () {
  ...
  d.wedge = function (a, b, c, e, h, f, g, k, l, m, n, q, p, t) {
    ...
    359.94 < z && (z = 359.94);
    h >= z && (h = z);
    var v = 1 / 180 * Math.PI, z = b + Math.sin(e * v) * k, A = c - Math.cos(e * v) * u, y = b + Math.sin(e * v) * f, B = c - Math.cos(e * v) * g, D = b + Math.sin((e + h) * v) * f, C = c - Math.cos((e + h) * v) * g, J = b + Math.sin((e + h) * v) * k, v = c - Math.cos((e + h) * v) * u, H = {
